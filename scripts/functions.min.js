$(".accordion-toggle").on("click", function() {
    ...
    function() {
        ...
        (t = jQuery).fn.flexNav = function(e) {
            ...
            }, e), (n = t(this)).addClass("with-js"), !0 === o.transitionOpacity && n.addClass("opacity"), n.find("li").each(function() {
                if (t(this).has("ul").length) return t(this).addClass("item-with-ul").find("ul").hide()
            }), t(o.buttonSelector).data("navEl", n), a = ".item-with-ul, " + o.buttonSelector, t(a).append('<span class="chevron chevron--button" title="Tap to expand" role="button" aria-pressed="false"></span>'), t(".flexnav__label").attr({
                title: "Tap to expand",
                role: "button",
                "aria-pressed": "false"
            }), i = o.buttonSelector + ", " + o.buttonSelector + " .chevron", t(i).on("click", function(e) {
                var n, a;
                return t(i).toggleClass("active"), e.preventDefault(), e.stopPropagation(), a = o.buttonSelector, n = t(this).is(a) ? t(this) : t(this).parent(a), n.data("navEl"), t("body").toggleClass("overflow-hidden"), t(".flexnav--full").toggleClass("flexnav-show")
            }), t(document).click(function(e) {
                t(e.target).closest(".flexnav--full").length || t(".flexnav--full").hasClass("flexnav-show") && (t(".flexnav--full").removeClass("flexnav-show"), t("body").removeClass("overflow-hidden"), t(".menu-button").removeClass("active"))
            }), t(".chevron").on("click", function(e) {
                t(this).attr("title", "Click to expand") ? (t(this).removeAttr("title").removeAttr("aria-pressed"), t(this).attr("title", "Click to collapse").attr("aria-pressed", "true")) : (t(this).removeAttr("title").removeAttr("aria-pressed"), t(this).attr("title", "Click to expand").attr("aria-pressed", "false")), t(this).toggleClass("chevron-up");
                var n, i;
                return n = t(this).parent(".item-with-ul").find(">ul"), i = t(this).parent(".item-with-ul").find(">span.chevron"), !0 === n.hasClass("flexnav-show") ? (n.removeClass("flexnav-show").slideUp(o.animationSpeed), i.removeClass("active")) : !1 === n.hasClass("flexnav-show") ? (n.addClass("flexnav-show").slideDown(o.animationSpeed), i.addClass("active")) : void 0
            }), t(".flexnav__label").on("click", function(e) {
                var n = t(this).siblings(".chevron");
                n.attr("title", "Tap to expand") ? (n.removeAttr("title").removeAttr("aria-pressed"), n.attr("title", "Tap to collapse").attr("aria-pressed", "true")) : (n.removeAttr("title").removeAttr("aria-pressed"), n.attr("title", "Tap to expand").attr("aria-pressed", "false")), n.toggleClass("chevron-up");
                var i, a;
                return i = t(this).parent(".item-with-ul").find(">ul"), a = t(this).parent(".item-with-ul").find(">span.chevron"), !0 === i.hasClass("flexnav-show") ? (i.removeClass("flexnav-show").slideUp(o.animationSpeed), a.removeClass("active")) : !1 === i.hasClass("flexnav-show") ? (i.addClass("flexnav-show").slideDown(o.animationSpeed), a.addClass("active")) : void 0
            })
        }
    }.call(this), null !== document.querySelector(".nav-header-strip") ? document.body.className += " nav-header-strip--padding" : document.querySelector(".nav-header").className += " border-bottom", window.FontAwesomeCdnConfig = {
    autoA11y: {
        enabled: !0
    },
    asyncLoading: {
    ...
    function() {
        function t(t) {
            ...
            t = t || "fa", e = document.querySelectorAll("." + t), Array.prototype.forEach.call(e, function(t) {
                n = t.getAttribute("title"), t.setAttribute("aria-hidden", "true"), o = !t.nextElementSibling || !t.nextElementSibling.classList.contains("sr-only"), n && o && (i = document.createElement("span"), i.innerHTML = n, i.classList.add("sr-only"), t.parentNode.insertBefore(i, t.nextSibling))
            })
        }! function() {
            function t(t) {
                this.el = t;
        ...
        var e, n, o, i, a, s, r, l = {
            ...
            c = {
                ...
                loadAsync: function(t, e, n, o) {
                    ...
                    window.WebFontConfig || (window.WebFontConfig = {}), (s = window.WebFontConfig).custom || (s.custom = {}), s.custom.families || (s.custom.families = []), s.custom.urls || (s.custom.urls = []), s.custom.testStrings || (s.custom.testStrings = {}), s.custom.families.push(e), s.custom.urls.push(t), s.custom.testStrings[e] = n, i = s.fontactive || r, s.fontactive = function(t, n) {
                        var o = (window.FontAwesomeHooks || {}).loaded || r;
                        i(t, n), e === t && "n4" === n && o()
                    }, a.src = o, l.parentNode.insertBefore(a, l)
                }
            },
            d = {
                load: function(t) {
        ...
        if (window.FontAwesomeCdnConfig && (e = window.FontAwesomeCdnConfig, n = e.useUrl, o = e.faCdnUrl, i = e.code, a = e.webFontLoaderVersion, e.autoA11y.enabled && (function(t) {
            var e, n = [],
                o = document,
                i = "DOMContentLoaded",
                a = (o.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(o.readyState);
            a || o.addEventListener(i, e = function() {
                for (o.removeEventListener(i, e), a = 1; e = n.shift();) e()
            }), a ? setTimeout(t, 0) : n.push(t)
        }(t.bind(t, "fa")), function(t) {
            "undefined" != typeof MutationObserver && new MutationObserver(t).observe(document, {
                childList: !0,
                subtree: !0
            })
        }(t.bind(t, "fa"))), e.reporting.enabled && function(t, e) {
            var n = !1;
            return t.split(",").forEach(function(t) {
                var o = new RegExp(t.trim().replace(".", "\\.").replace("*", "(.*)"));
                e.match(o) && (n = !0)
            }), n
        }(e.reporting.domains, location.host) && d.load(o + "/js/stats.js"), r = "https://" + n + "/" + i + ".css", s = "https://" + n + "/webfontloader/" + a + "/webfontloader.js", e.asyncLoading.enabled ? c.loadAsync(r, "FontAwesome", "ï‰€", s) : c.load(r)), window.FortAwesomeConfig) {
...
}), $(".tab__content:first").addClass("tab__content--open"), $(".tab__item").click(function() {
                            ...
                            ! function t() {
                                a(setTimeout(function() {
                                    var n = Math.min(((new Date).getTime() - m) / i, 1),
                                        o = Math.max(Math.floor(u + f * (n < .5 ? 2 * n * n : n * (4 - 2 * n) - 1)), 0);
