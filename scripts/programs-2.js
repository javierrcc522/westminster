! function(e) {
    ...
    var s = function() {
        ...
        return o(e, [{
            ...
            value: function(e) {
                ...
                for (var t = [].concat(u(document.querySelectorAll("[data-jplist-item]"))), r = 0; r < t.length; r++) t[r].jplistIndex = r;
                this.refresh("")
            }
        }, {
            key: "refresh",
            ...
            value: function(e) {
                ...
                e && e(this.groups), this.elements = document.querySelectorAll("[data-jplist-group]"), this.groups = i.default.findGroups(this.elements);
                for (var m = [].concat(u(document.querySelectorAll("[data-jplist-item]"))), g = 0; g < m.length; g++) m[g].jplistIndex = g;
                this.refresh("")
            }
        }]), e
    }();
    ...
    function S(e) {
        ...
        var t = new n.default;
        window.jplist.init = t.init.bind(t), window.jplist.refresh = t.refresh.bind(t), window.jplist.resetControls = t.resetControls.bind(t), window.jplist.resetControl = t.resetControl.bind(t), window.jplist.resetContent = t.resetContent.bind(t)
    }()
